...
const TEMPLATE_LIST = [
  ...
  { id: 'g-dawn', category: 'greeting', text: 'Up before the Crier. Small victories.', needs: [], voice: 'keen' },
  { id: 'g-tired', category: 'greeting', text: 'Here. Barely.', needs: [] },
  { id: 'g-roll', category: 'greeting', text: 'Right, who is doing what today?', needs: [], voice: 'keen' },
  { id: 'g-nod', category: 'greeting', text: 'Hall.', needs: [], voice: 'gruff' },
  { id: 'b-level-4', category: 'brag', text: 'Ding. {level}.', needs: ['level'], voice: 'sociable' },
  { id: 'b-level-5', category: 'brag', text: 'That is {hero} past {level} before most of us were up.', needs: ['hero', 'level'] },
  { id: 'b-rank-4', category: 'brag', text: 'Up {count} rungs this morning.', needs: ['count'] },
  { id: 'b-item-3', category: 'brag', text: 'A {item} out of {zone} of all places.', needs: ['item', 'zone'] },
  { id: 'b-gold-2', category: 'brag', text: '{hero} came back with {gold} gold. From one afternoon.', needs: ['hero', 'gold'] },
  { id: 'b-quiet', category: 'brag', text: 'Not saying anything. Just check the board.', needs: [], voice: 'gruff' },
  { id: 'r-slip-3', category: 'grumble', text: 'Rank {rank}. It was better before I went to bed.', needs: ['rank'] },
  { id: 'r-drop', category: 'grumble', text: '{count} contracts and not one drop worth the bag space.', needs: ['count'] },
  { id: 'r-loss-3', category: 'grumble', text: '{other} again. That is becoming a pattern.', needs: ['other'], voice: 'gruff' },
  { id: 'r-zone-2', category: 'grumble', text: 'Whatever is loose in {zone} hits far harder than it looks.', needs: ['zone'] },
  { id: 'r-purse', category: 'grumble', text: 'Bram wanted {gold} for a helmet. A helmet.', needs: ['gold'] },
  { id: 'r-tired', category: 'grumble', text: 'Long week. That is all.', needs: [] },
  { id: 'm-zone-3', category: 'mission', text: 'Anyone else been out to {zone} today?', needs: ['zone'], voice: 'sociable' },
  { id: 'm-tip-2', category: 'mission', text: 'Do not go past {zone} without a mount. Learn from me.', needs: ['zone'] },
  { id: 'm-count-3', category: 'mission', text: 'That is {count} for the bounty from me.', needs: ['count'], voice: 'keen' },
  { id: 'm-board', category: 'mission', text: 'The board is thin today. Rerolling.', needs: [] },
  { id: 'm-level', category: 'mission', text: 'Nearly {level}. One more good run.', needs: ['level'] },
  { id: 'm-back', category: 'mission', text: 'Home, filthy, paid. A good day.', needs: [], voice: 'sociable' },
  { id: 'a-win-3', category: 'arena', text: 'Rank {rank} and climbing. The sand has been good to me.', needs: ['rank'], voice: 'keen' },
  { id: 'a-loss-2', category: 'arena', text: '{hero} went down to {other}. It happens to all of us.', needs: ['hero', 'other'], voice: 'sociable' },
  { id: 'a-raid-2', category: 'arena', text: 'Woke up {count} rungs lower. Somebody has been busy.', needs: ['count'] },
  { id: 'a-watch', category: 'arena', text: 'Watching {hero} fight is worth the walk over.', needs: ['hero'], voice: 'sociable' },
  { id: 'a-advice', category: 'arena', text: 'Read them before you swing. The board tells you plenty.', needs: [], voice: 'gruff' },
  { id: 'a-bell', category: 'arena', text: 'Waiting on the bell. Again.', needs: [] },
  { id: 'd-in-3', category: 'donation', text: '{gold} to the Drillmaster. Spend it well.', needs: ['gold'] },
  { id: 'd-step-3', category: 'donation', text: 'That is {count} steps on the Treasury now. Adds up.', needs: ['count'] },
  { id: 'd-ask', category: 'donation', text: 'How far off the next step are we?', needs: [], voice: 'sociable' },
  { id: 'd-proud', category: 'donation', text: 'Best-funded hall on the board and I will hear no argument.', needs: [], voice: 'keen' },
  { id: 'd-dice', category: 'donation', text: 'Threw a die in the pot. Felt strange. Did it anyway.', needs: [] },
  { id: 'w-join-5', category: 'welcome', text: 'Good to have you, {hero}.', needs: ['hero'], voice: 'sociable' },
  { id: 'w-join-6', category: 'welcome', text: '{hero} joins us at rank {rank}. Not bad.', needs: ['hero', 'rank'] },
  { id: 'w-join-7', category: 'welcome', text: 'Make room, {hero} is in.', needs: ['hero'], voice: 'keen' },
  { id: 'w-founder', category: 'welcome', text: '{guild} has a hall of its own now. Somebody put the kettle on.', needs: ['guild'], voice: 'sociable' },
  { id: 'f-left-3', category: 'farewell', text: '{hero} has moved on. No hard feelings.', needs: ['hero'] },
  { id: 'f-left-4', category: 'farewell', text: 'Down to {count} of us.', needs: ['count'], voice: 'gruff' },
  { id: 'f-kick-3', category: 'farewell', text: '{hero} is gone and the pot is no emptier for it.', needs: ['hero'], voice: 'gruff' },
  { id: 'f-quiet-2', category: 'farewell', text: 'Has anyone heard from {hero}?', needs: ['hero'], voice: 'sociable' },
  { id: 'y-progress-3', category: 'bounty', text: '{percent}% and climbing. {bounty} is going down.', needs: ['percent', 'bounty'], voice: 'keen' },
  { id: 'y-carry-2', category: 'bounty', text: '{hero} has done more for this bounty than the rest of us together.', needs: ['hero'] },
  { id: 'y-push', category: 'bounty', text: 'One good evening and {bounty} is finished.', needs: ['bounty'], voice: 'keen' },
  { id: 'y-half', category: 'bounty', text: 'Half a chest is still a chest. {percent}%.', needs: ['percent'] },
  { id: 'p-hi-4', category: 'reply', text: 'There they are.', needs: [], voice: 'sociable' },
  { id: 'p-grats-4', category: 'reply', text: 'Grats {hero}, that is a good one.', needs: ['hero'], voice: 'sociable' },
  { id: 'p-tease-3', category: 'reply', text: 'Modest as ever.', needs: [], voice: 'gruff' },
  { id: 'p-sympathy-3', category: 'reply', text: 'Happens to everyone. Even {other}.', needs: ['other'] },
  { id: 'p-agree-3', category: 'reply', text: 'Same here.', needs: [] },
  { id: 'p-question-3', category: 'reply', text: 'Try the long contracts. That is what I would do.', needs: [] },
  { id: 'p-welcome-back', category: 'reply', text: 'Welcome back {hero}.', needs: ['hero'], voice: 'sociable' },
  { id: 'i-market', category: 'idle', text: 'Market day. Emberhollow smells of onions.', needs: [] },
  { id: 'i-marla', category: 'idle', text: 'Marla has changed the ale and is pretending she has not.', needs: [] },
  { id: 'i-menagerie', category: 'idle', text: 'Something in the Menagerie has learned to open its latch.', needs: [] },
  { id: 'i-roof', category: 'idle', text: 'The hall roof leaks over exactly one chair and we all know which.', needs: [] },
  { id: 'i-bram', category: 'idle', text: 'Bram called my weapon "serviceable". I am still thinking about it.', needs: [] },
  { id: 'i-night', category: 'idle', text: 'Nobody awake but me and the lanterns.', needs: [], voice: 'gruff' },
